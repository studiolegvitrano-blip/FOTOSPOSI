        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-text-muted mt-1">
              Durante la registrazione vedrai un testo suggerito in basso come promemoria.
              Puoi seguirlo o parlare liberamente. Alla fine rivedi il video prima di inviarlo.
            </p>
          </CardHeader>
