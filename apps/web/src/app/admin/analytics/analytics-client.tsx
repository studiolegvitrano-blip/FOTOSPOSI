...
export default function AnalyticsClient({ data, activation, engagement, viral, b2b }: AdminAnalyticsClientProps) {
        ...
        <TabsContent value="engagement" className="space-y-4">
          {engagement.length > 0 ? (
            <div className="grid gap-4">
              {engagement.slice(0, 20).map((e: any) => (
                <Card key={e.event_id}>
          ...
          {viral && viral.total_shares > 0 ? (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {viral.shares_by_medium && Object.keys(viral.shares_by_medium).length > 0 && (
                  <Card>
                ...
                {viral.shares_by_content && Object.keys(viral.shares_by_content).length > 0 && (
                  <Card>
