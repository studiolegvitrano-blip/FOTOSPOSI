...
- [ ] **Da pushare e verificare**: fix Bug 7 corretta sul disco, non ancora committata — poi ricontrollare il build su Vercel (`next build` si ferma al primo errore incontrato, quindi potrebbero emergere altri type error non ancora scoperti in giri successivi).
